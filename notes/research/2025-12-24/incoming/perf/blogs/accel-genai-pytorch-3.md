Title: Accelerating Generative AI Part III: Diffusion, Fast – PyTorch

URL Source: https://pytorch.org/blog/accelerating-generative-ai-3/
...
Enabling these optimizations with the ![Image 1: 🤗](https://s.w.org/images/core/emoji/17.0.2/svg/1f917.svg)Diffusers library takes just a few lines of code. If you’re already feeling excited and cannot wait to jump to the code, check out the accompanying repository here:[https://github.com/huggingface/diffusion-fast](https://github.com/huggingface/diffusion-fast).

![Image 2: SDXL Chart](https://pytorch.org/wp-content/uploads/2024/11/fg1-11.png)
...
Setup[](https://pytorch.org/blog/accelerating-generative-ai-3/#setup)
---------------------------------------------------------------------

We will demonstrate the optimizations and their respective speed-up gains using the ![Image 3: 🤗](https://s.w.org/images/core/emoji/17.0.2/svg/1f917.svg)[Diffusers library](https://github.com/huggingface/diffusers). Apart from that, we will make use of the following PyTorch-native libraries and environments:

*   Torch nightly (to benefit from the fastest kernels for efficient attention; 2.3.0.dev20231218+cu121)
*   ![Image 4: 🤗](https://s.w.org/images/core/emoji/17.0.2/svg/1f917.svg) PEFT (version: 0.7.1)
...
Run inference using a reduced precision[](https://pytorch.org/blog/accelerating-generative-ai-3/#run-inference-using-a-reduced-precision)
-----------------------------------------------------------------------------------------------------------------------------------------
...
![Image 5: SDXL Chart](https://pytorch.org/wp-content/uploads/2024/11/fg2-10.png)
...
image = pipe(prompt, num_inference_steps=30).images[0]
```
![Image 6: SDXL Chart](https://pytorch.org/wp-content/uploads/2024/11/fg3-10.png)
...
Use SDPA for performing attention computations[](https://pytorch.org/blog/accelerating-generative-ai-3/#use-sdpa-for-performing-attention-computations)
-------------------------------------------------------------------------------------------------------------------------------------------------------
...
![Image 7: SDXL Chart](https://pytorch.org/wp-content/uploads/2024/11/fg4-5.png)
Compiling the UNet and VAE[](https://pytorch.org/blog/accelerating-generative-ai-3/#compiling-the-unet-and-vae)
---------------------------------------------------------------------------------------------------------------
...
![Image 8: SDXL Chart](https://pytorch.org/wp-content/uploads/2024/11/fg5-7.png)
...
Additional optimizations[](https://pytorch.org/blog/accelerating-generative-ai-3/#additional-optimizations)
-----------------------------------------------------------------------------------------------------------

### No graph breaks during`torch.compile`[](https://pytorch.org/blog/accelerating-generative-ai-3/#no-graph-breaks-during-torchcompile)
...
![Image 9: code example](https://pytorch.org/wp-content/uploads/2024/11/fg5b.jpg)
### Getting rid of GPU syncs after compilation[](https://pytorch.org/blog/accelerating-generative-ai-3/#getting-rid-of-gpu-syncs-after-compilation)
...
### Using combined projections for attention ops[](https://pytorch.org/blog/accelerating-generative-ai-3/#using-combined-projections-for-attention-ops)
...
![Image 10: SDXL Chart](https://pytorch.org/wp-content/uploads/2024/11/fg6-7.png)
Dynamic int8 quantization[](https://pytorch.org/blog/accelerating-generative-ai-3/#dynamic-int8-quantization)
-------------------------------------------------------------------------------------------------------------
...
![Image 11: SDXL Chart](https://pytorch.org/wp-content/uploads/2024/11/fg7-6.png)
Resources[](https://pytorch.org/blog/accelerating-generative-ai-3/#resources)
-----------------------------------------------------------------------------
...
Improvements in other pipelines[](https://pytorch.org/blog/accelerating-generative-ai-3/#improvements-in-other-pipelines)
-------------------------------------------------------------------------------------------------------------------------

We applied these techniques to other pipelines to test the generality of our approach. Below are our findings:

### [SSD-1B](https://huggingface.co/segmind/SSD-1B)[](https://pytorch.org/blog/accelerating-generative-ai-3/#ssd-1b)

![Image 12: SSD-1B Chart](https://pytorch.org/wp-content/uploads/2024/11/fg8-5.png)
### [Stable Diffusion v1-5](https://huggingface.co/runwayml/stable-diffusion-v1-5)[](https://pytorch.org/blog/accelerating-generative-ai-3/#stable-diffusion-v1-5)

![Image 13: Stable Diffusion v1-5 chart](https://pytorch.org/wp-content/uploads/2024/11/fg9-5.png)
### [PixArt-alpha/PixArt-XL-2-1024-MS](https://huggingface.co/PixArt-alpha/PixArt-XL-2-1024-MS)[](https://pytorch.org/blog/accelerating-generative-ai-3/#pixart-alphapixart-xl-2-1024-ms)
...
![Image 14: PixArt-alpha/PixArt-XL-2-1024-MS chart](https://pytorch.org/wp-content/uploads/2024/11/fg10-2.png)
...
Conclusion and next steps[](https://pytorch.org/blog/accelerating-generative-ai-3/#conclusion-and-next-steps)
-------------------------------------------------------------------------------------------------------------
...
Acknowledgements[](https://pytorch.org/blog/accelerating-generative-ai-3/#acknowledgements)
-------------------------------------------------------------------------------------------
