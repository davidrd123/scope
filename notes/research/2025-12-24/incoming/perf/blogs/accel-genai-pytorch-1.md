Title: Segment Anything, Fast – PyTorch

URL Source: https://pytorch.org/blog/accelerating-generative-ai/
...
![Image 1: With 2:4 sparsity, we observe peak performance on SAM with vit_b and batch size 32](https://pytorch.org/wp-content/uploads/2024/11/bar_chart_7.png)
...
SegmentAnything Model[](https://pytorch.org/blog/accelerating-generative-ai/#segmentanything-model)
---------------------------------------------------------------------------------------------------

[SAM](https://github.com/facebookresearch/segment-anything)is a zero-shot vision model for generating promptable image masks.

![Image 2: sam image masks](https://pytorch.org/wp-content/uploads/2024/11/intro_image.jpg)
...
Optimizations[](https://pytorch.org/blog/accelerating-generative-ai/#optimizations)
-----------------------------------------------------------------------------------
...
### Baseline[](https://pytorch.org/blog/accelerating-generative-ai/#baseline)
...
![Image 3: kernel trace](https://pytorch.org/wp-content/uploads/2024/11/baseline_trace.jpg)
...
![Image 4: throughput (img/s) and memory overhead (GiB) from out of the box SAM](https://pytorch.org/wp-content/uploads/2024/11/bar_chart_0.png)
### Bfloat16 Half precision (+GPU syncs and batching)[](https://pytorch.org/blog/accelerating-generative-ai/#bfloat16-half-precision-gpu-syncs-and-batching)
...
![Image 5: replacing padding dtypes with half precision, bfloat16](https://pytorch.org/wp-content/uploads/2024/11/bfloat16_snippet.jpg)
_Shown here is an example of replacing padding dtypes with half precision, bfloat16.[Code is here](https://github.com/pytorch-labs/segment-anything-fast/blame/main/segment\_anything\_fast/modeling/prompt\_encoder.py#L86)._
...
![Image 6: code sample 1](https://pytorch.org/wp-content/uploads/2024/11/code1.jpg)![Image 7: replacing padding dtypes with half precision, bfloat16](https://pytorch.org/wp-content/uploads/2024/11/bfloat16_snippet2.jpg)
...
![Image 8: profile SAM inference with batch size 8](https://pytorch.org/wp-content/uploads/2024/11/bfloat16_trace.jpg)
...
![Image 9: matrix multiplications have become a much smaller relative overhead](https://pytorch.org/wp-content/uploads/2024/11/bfloat16_kernels.jpg)
Taken the GPU sync and bfloat16 optimizations together, we have now pushed SAM performance by up to 3x

![Image 10: SAM performance by up to 3x](https://pytorch.org/wp-content/uploads/2024/11/bar_chart_1.png)
### Torch.compile (+graph breaks and CUDA graphs)[](https://pytorch.org/blog/accelerating-generative-ai/#torchcompile-graph-breaks-and-cuda-graphs)
...
![Image 11: Kernel trace](https://pytorch.org/wp-content/uploads/2024/11/compile_trace.jpg)
...
![Image 12: the percentage of GPU time spent in specific kernels](https://pytorch.org/wp-content/uploads/2024/11/compile_kernels.jpg)
...
![Image 13: measurements for batch size 8 and above](https://pytorch.org/wp-content/uploads/2024/11/bar_chart_2.png)
### SDPA: scaled_dot_product_attention[](https://pytorch.org/blog/accelerating-generative-ai/#sdpa-scaled_dot_product_attention)
...
![Image 14: PyTorch native attention implementation](https://pytorch.org/wp-content/uploads/2024/11/sdpa_snippet.jpg)
_PyTorch native attention implementation,[see code here](https://github.com/pytorch-labs/segment-anything-fast/blob/main/segment\_anything\_fast/modeling/image\_encoder.py#L236)._
...
![Image 15: memory efficient attention kernel is taking up a large amount of computational time on the GPU](https://pytorch.org/wp-content/uploads/2024/11/sdpa_kernels.jpg)
...
![Image 16: batch size 32 and above](https://pytorch.org/wp-content/uploads/2024/11/bar_chart_3.png)
### Triton: Custom SDPA for fused relative positional encoding[](https://pytorch.org/blog/accelerating-generative-ai/#triton-custom-sdpa-for-fused-relative-positional-encoding)
...
![Image 17: spikes in memory allocation](https://pytorch.org/wp-content/uploads/2024/11/triton_trace.png)
...
![Image 18: we see this allocation happens within add_decomposed_rel_pos](https://pytorch.org/wp-content/uploads/2024/11/triton_snippet.jpg)
...
![Image 19: kernel trace](https://pytorch.org/wp-content/uploads/2024/11/triton_kernels.jpg)
With our custom positional Triton kernel we observe the following measurements for batch size 32.

![Image 20: we observe the following measurements for batch size 32](https://pytorch.org/wp-content/uploads/2024/11/bar_chart_4.png)
### NT: NestedTensor and batching predict_torch[](https://pytorch.org/blog/accelerating-generative-ai/#nt-nestedtensor-and-batching-predict_torch)
...
![Image 21: Kernel trace](https://pytorch.org/wp-content/uploads/2024/11/trace1.jpg)![Image 22: we can launch kernels much faster from the CPU than the GPU can process](https://pytorch.org/wp-content/uploads/2024/11/nt_kernel.jpg)
...
![Image 23: batch size 32 and above changes](https://pytorch.org/wp-content/uploads/2024/11/bar_chart_5.png)
### int8: quantization and approximating matmul[](https://pytorch.org/blog/accelerating-generative-ai/#int8-quantization-and-approximating-matmul)
...
![Image 24: batch size 32 and above changes](https://pytorch.org/wp-content/uploads/2024/11/bar_chart_6.png)
### sparse: Semi-structured (2:4) sparsity[](https://pytorch.org/blog/accelerating-generative-ai/#sparse-semi-structured-24-sparsity)
...
![Image 25: dense tensor output that can leverage highly performant, 2:4 GPU kernels](https://pytorch.org/wp-content/uploads/2024/11/sparse_image.png)
...
![Image 26: With 2:4 sparsity, we observe peak performance on SAM with vit_b and batch size 32](https://pytorch.org/wp-content/uploads/2024/11/bar_chart_7.png)
### Conclusion[](https://pytorch.org/blog/accelerating-generative-ai/#conclusion)
...
### Acknowledgements[](https://pytorch.org/blog/accelerating-generative-ai/#acknowledgements)
