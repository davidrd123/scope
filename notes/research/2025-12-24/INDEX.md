...
| `notes/research/2025-12-24/incoming/rest_endpoint/5pro_rest_feedback.md` + `notes/research/2025-12-24/incoming/rest_endpoint/testing_cmds.md` | REST control surface | INTEGRATED | `src/scope/server/app.py` (realtime endpoints), `src/scope/server/webrtc.py` (apply_control_message), `src/scope/cli/video_cli.py`, `tests/test_realtime_rest_*` |
