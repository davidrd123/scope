...
if not hasattr(cute, "make_rmem_tensor"):
...
def apply_score_mod_inner(
    ...
    batch_idx_vec = cute.make_rmem_tensor(vec_size, cutlass.Int32)
...
def apply_score_mod_bwd_inner(
    ...
    batch_idx_vec = cute.make_fragment(vec_size, cutlass.Int32)
